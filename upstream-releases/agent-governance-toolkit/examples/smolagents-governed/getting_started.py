...
For the full 9-scenario showcase, run smolagents_governance_demo.py instead.
"""
...
async def main() -> None:
    print("=" * 60)
    print("  smolagents + Governance Toolkit — Getting Started")
    print("=" * 60)

    # --- Check 1: Safe message passes policy ---
    print("\n[1] Researcher sends a safe query...")
    ctx = AgentContext("researcher", "Search for recent AI safety papers")
    ...
    ctx2 = AgentContext("data_analyst", "Include john.doe@example.com in the report")
