...
--     * Slot: dimension_kind Description: Which of the five dimensions this instance represents.
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
...
--     * Slot: stage_kind Description: Which of the six stages this instance represents.
--     * Slot: includes_tevv Description: Whether this stage incorporates TEVV activities.
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
...
--     * Slot: task_kind Description: Which of the actor task categories this is.
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
...
--     * Slot: affects_system Description: The AI system this risk pertains to.
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
...
--     * Slot: tolerance_statement Description: Free-text statement of the tolerance level or threshold.
--     * Slot: legal_basis Description: Legal or regulatory requirements influencing the tolerance.
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
-- # Class: RiskMeasurementChallenge Description: A challenge that complicates measurement of AI risks(Part 1 §1.2.1).
--     * Slot: challenge_kind Description: Which measurement challenge this represents.
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
...
--     * Slot: characteristic_kind Description: Which trustworthiness characteristic this instance represents.
--     * Slot: is_base_condition Description: True when this is a necessary condition for trustworthiness(Valid and Reliable; per Figure 4 it is the base of all othercharacteristics).
...
--     * Slot: sector Description: The sector, industry, technology, or end-use application theprofile addresses (e.g., "hiring", "fair housing").
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
...
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
--     * Slot: document_id Description: Publication metadata.
...
--     * Slot: third_party_considerations Description: Considerations for third-party GAI integrations,procurement, SBOMs, SLAs, and SSAE reports (A.1.3).
--     * Slot: limitations_of_current_approaches Description: For Pre-Deployment Testing: free-text discussion of whycurrent TEVV approaches may be inadequate (A.1.4).
--     * Slot: ai_incident_definition Description: For Incident Disclosure: the definition of AI incidentused by the organisation (A.1.8).
--     * Slot: id Description: A unique identifier for an element.
--     * Slot: name Description: A short human-readable name.
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
...
--     * Slot: title Description: A human-readable title.
--     * Slot: description Description: A human-readable description.
-- # Class: GaiProfile Description: Root container that bundles the NIST AI 600-1 Generative AIProfile: GAI risks (Section 2), suggested actions (Section 3),and primary considerations (Appendix A).
--     * Slot: profile_type Description: The kind of AI RMF Profile.
--     * Slot: current_state Description: For temporal current profiles - how AI is currently being managedand related risks in terms of current outcomes.
--     * Slot: target_state Description: For temporal target profiles - the outcomes needed to achieve thedesired AI risk management goals.
--     * Slot: sector Description: The sector, industry, technology, or end-use application theprofile addresses (e.g., "hiring", "fair housing").
...
--     * Slot: AiActorTask_id Description: Autocreated FK slot
--     * Slot: typical_actors Description: Representative actor roles that perform this task.
...
--     * Slot: addresses_id Description: Subcategories that the profile implements or addresses.
...
--     * Slot: GaiRisk_id Description: Autocreated FK slot
--     * Slot: addressed_by_actions_id Description: Suggested actions that address this risk (back-reference).
...
--     * Slot: governance_practices Description: Governance plans and actions (A.1.2) - e.g., "Auditing andassessment", "Data provenance", "Incident response","Impact assessments", "Stakeholder engagement", "Syntheticcontent detection", "Whistleblower protections".
-- # Class: PrimaryGaiConsideration_provenance_techniques
--     * Slot: PrimaryGaiConsideration_id Description: Autocreated FK slot
--     * Slot: provenance_techniques Description: For Content Provenance: provenance data trackingtechniques such as digital watermarking, metadatarecording, digital fingerprinting, human authentication(A.1.6).
...
CREATE TABLE "GaiProfile_addresses" (
	"GaiProfile_id" TEXT,
	addresses_id TEXT,
	PRIMARY KEY ("GaiProfile_id", addresses_id),
	FOREIGN KEY("GaiProfile_id") REFERENCES "GaiProfile" (id),
	FOREIGN KEY(addresses_id) REFERENCES "Subcategory" (id)
);
CREATE INDEX "ix_GaiProfile_addresses_GaiProfile_id" ON "GaiProfile_addresses" ("GaiProfile_id");
CREATE INDEX "ix_GaiProfile_addresses_addresses_id" ON "GaiProfile_addresses" (addresses_id);
